      ...
      <section id="teacher" className="border-y border-border bg-card/30">
        <div className="container py-24 lg:py-32 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-6 text-lg leading-relaxed">
              Наставник не читает лекции — он разбирает с ребёнком его проект так же, как с клиентом на реальном продакшене: честная обратная связь и профессиональные критерии, а не поблажки «для детей». За плечами — педагогическое образование, годы в реальном медиапродакшене и десятки коммерческих работ, поэтому ребёнок с первого дня чувствует себя не учеником, а автором, чьё мнение уважают.
            </p>
