...
const program = [
  {
    day: '01',
    tag: 'Сценарий и Weavy',
    title: 'Придумываю историю',
    text: 'Регистрация и обзор интерфейса Weavy. Разработка идеи и написание пошагового сценария для вашего будущего видеопроекта.',
    icon: 'PenLine',
  },
  {
    day: '02',
    tag: 'Нейромузыка в Suno',
    title: 'Пишу свой первый трек',
    text: 'Знакомство с платформой Suno. Создание уникального музыкального сопровождения и атмосферы ролика строго по вашему сценарию.',
    icon: 'Music',
  },
  {
    day: '03',
    tag: 'Персонажи и раскадровка',
    title: 'Рисую мир своего клипа',
    text: 'Создание главного героя и визуального стиля. Генерация идеальных стартовых кадров для их последующего оживления.',
    icon: 'Image',
  },
  {
    day: '04',
    ...
    text: 'Оживление изображений. Изучение принципов анимации: работа с первым кадром и создание плавных переходов (от кадра к кадру).',
    icon: 'Clapperboard',
  },
  {
    day: '05',
    ...
    text: 'Сборка видеоряда и звука воедино. Изучение базовых принципов динамичного монтажа в приложении InShot.',
    icon: 'Scissors',
  },
  {
    day: '06',
    tag: 'Прямой эфир и разбор',
    title: 'Разбираю проект с наставником',
    text: 'Интерактивный формат Q&A. Индивидуальная проверка работ, корректировка проектов и ответы на все вопросы участников.',
    icon: 'MessagesSquare',
  },
  {
    day: '07',
    ...
    text: 'Финальный выпускной! Демонстрация готовых видеороликов, обмен впечатлениями и подведение итогов интенсива.',
    icon: 'Rocket',
  },
];
...
const faq = [
  ...
  {
    q: 'Нужен ли Google-аккаунт?',
    a: 'Да, для прохождения интенсива понадобится действующий аккаунт Google — через него открывается доступ к нужным нейросетям и учебным материалам.',
  },
  {
        ...
        <div className="container relative z-10 py-24">
          <div className="grid lg:grid-cols-[1fr_auto] gap-12 items-center">
            <div className="max-w-4xl">
              ...
              <h1 className="reveal font-display uppercase leading-[1.35] text-5xl sm:text-7xl lg:text-8xl font-bold tracking-tight" style={{ animationDelay: '0.05s' }}>
        ...
        <div className="container py-24 lg:py-32 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-6 text-lg leading-relaxed">
              Наставник не просто даёт материал для обучения — он разбирает проект ребёнка как с клиентом на реальном продакшене: честно и по-взрослому. Педагогическое образование и годы в медиапродакшене — ребёнок с первого дня чувствует себя автором, а не учеником.
            </p>
      ...
      <section id="register" className="relative overflow-hidden">
        ...
        <div className="container py-24 lg:py-32 relative">
          <div className="max-w-xl mx-auto text-center">
            ...
            <h2 className="font-display uppercase text-4xl sm:text-6xl mt-4 leading-none">
              Именно здесь начнется осознанный путь вашего ребёнка в мир <span className="text-primary">цифрового творчества</span>
            </h2>
            <p className="text-muted-foreground mt-5 text-lg">
            ...
            <p className="text-muted-foreground mt-3 text-lg">
              Мы честно скажем, подойдет ли интенсив вашему ребенку.
            </p>
          </div>
